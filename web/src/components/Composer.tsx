...
import { send, setAttachment, clearAttachment, toggleImageMode } from "../lib/agent";
...
export default function Composer() {
  const { attached, imageMode, streaming } = useStore();
  ...
  const submit = () => { if (streaming) return; const v = value; setValue(""); send(v); };
  ...
  return (
    ...
    >
      ...
      <div className="inputwrap">
        ...
        />
        <button className="send" aria-label="Send" disabled={streaming} onClick={submit}>
